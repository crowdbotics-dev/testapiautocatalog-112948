...
## Project Structure
    ...
    ├── testapiautocatalog_112948  # Django project configurations
...
1. Clone this repo and `cd testapiautocatalog_112948`
...
2. Clone this repo and `cd testapiautocatalog_112948`
